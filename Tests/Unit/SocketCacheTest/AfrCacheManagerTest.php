...
namespace Unit\SocketCacheTest;
...
class AfrCacheManagerTest extends TestCase
{
    ...
    public function arrayStoreTest(string $sKey, $mData): void
    {
        ...
        $this->assertSame(true, $oRepo->getStore()  instanceof \Autoframe\Core\SocketCache\LaravelPort\Cache\ArrayStore);
    ...
    public function fileStoreTest(string $sKey, $mData): void
    {
        ...
        //$this->assertSame(true, strpos(get_class($oRepo),'ArrayStore')!==false);
        $this->assertSame(true, $oRepo->getStore() instanceof \Autoframe\Core\SocketCache\LaravelPort\Cache\FileStore);
    ...
    public function memcachedStoreTest(string $sKey, $mData): void
    {
        ...
        //$this->assertSame(true, strpos(get_class($oRepo),'ArrayStore')!==false);
        $this->assertSame(true, $oRepo->getStore() instanceof  \Autoframe\Core\SocketCache\LaravelPort\Cache\MemcachedStore);
    ...
    public function apcStoreTest(string $sKey, $mData): void
    {
        ...
        //$this->assertSame(true, strpos(get_class($oRepo),'ArrayStore')!==false);
        $this->assertSame(true, $oRepo->getStore() instanceof \Autoframe\Core\SocketCache\LaravelPort\Cache\ApcStore);
    }
