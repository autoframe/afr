...
use Autoframe\Core\SocketCache\Exception\AfrCacheSocketException;
use Autoframe\Core\SocketCache\Integrity\AfrSocketIntegrityClass;
use Autoframe\Core\SocketCache\Integrity\AfrSocketIntegrityInterface;
use Autoframe\Core\SocketCache\Server\AfrSocketServer;
use Autoframe\Core\SocketCache\Server\AfrServerStore;
...
class AfrCacheSocketConfig
{
    ...
    public string $sServerStoreFQCN = AfrServerStore::class; //implememts Autoframe\Core\SocketCache\LaravelPort\Contracts\Cache\Store
