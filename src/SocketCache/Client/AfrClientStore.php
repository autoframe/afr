...
namespace Autoframe\Core\SocketCache\Client;

use Autoframe\Core\SocketCache\AfrCacheSocketConfig;
use Autoframe\Core\SocketCache\Common\AfrCacheSocketStore;
...
class AfrClientStore extends AfrCacheSocketStore
{
    ...
    public function shutdownServer(): array
    {
        ...
        if(class_exists('\Autoframe\Core\SocketCache\Facade\AfrCache')){
            \Autoframe\Core\SocketCache\Facade\AfrCache::getManager()->forgetDriver($this->oSocketConfig->driver);
        }
