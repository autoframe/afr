...
use Autoframe\Core\SocketCache\LaravelPort\Contracts\Events\Dispatcher as DispatcherContract;
use Autoframe\Core\SocketCache\LaravelPort\Support\Arr;
use InvalidArgumentException;

/**
 * @mixin \Autoframe\Core\SocketCache\LaravelPort\Contracts\Cache\Repository
 */
class CacheManager
{
    /**
     ...
     * @return \Autoframe\Core\SocketCache\LaravelPort\Contracts\Cache\Repository
     */
    ...
    protected function resolve($name)
    {
        ...
        if (isset($this->customCreators[$config['driver']])) {
            ...
            if (method_exists($this, $driverMethod)) {
                ...
                throw new InvalidArgumentException("Driver [{$config['driver']}] is not supported.".print_r($this->customCreators,true));
            }
        }
    }
    ...
    {
        $this->setEventDispatcher($oRepo = new Repository($store));
        return $oRepo;

        return Tap::tap(new Repository($store), function ($repository) {
