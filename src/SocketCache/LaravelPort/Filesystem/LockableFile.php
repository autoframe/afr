...
class LockableFile
{
    ...
    protected function createResource($path, $mode)
    {
        ...
        if (! $this->handle) {
            throw new AfrException('Unable to create lockable file: '.$path.'. Please ensure you have permission to create files in this location.');
        }
    }
