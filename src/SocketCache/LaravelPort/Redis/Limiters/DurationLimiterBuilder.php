...
namespace Autoframe\Core\SocketCache\LaravelPort\Redis\Limiters;

use Autoframe\Core\SocketCache\LaravelPort\Contracts\Redis\LimiterTimeoutException;
...
class DurationLimiterBuilder
{
     ...
     *
     * @var \Autoframe\Core\SocketCache\LaravelPort\Redis\Connections\Connection
     */
    public $connection;
     ...
     * @return mixed
     *
     * @throws \Autoframe\Core\SocketCache\LaravelPort\Contracts\Redis\LimiterTimeoutException
     */
