...
class AfrStr
{
     ...
     * @var int bitwise
     */
    public static int $iFlagsHtmlentities = ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401;

    /**
     * @var int bitwise
     */
    public static int $iFlagsHtmlspecialchars = ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401;
